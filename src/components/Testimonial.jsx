...
const Testimonial = () => {
  ...
  const testimonials = [
    {
      id: 1,
      quote: "Following a sports nutrition plan for the past 4 months has completely transformed my performance. Before, I struggled with low energy and early fatigue. Now, I feel consistently energized through my workouts and recovery is much faster!",
    ...
    {
      id: 2,
      quote: "As a marathon runner, proper nutrition is everything. The customized plan I received addressed all my specific needs and has helped me shave 15 minutes off my personal best. The guidance on timing my nutrients has been game-changing.",
      name: "Sarah Chen",
    ...
    {
      id: 3,
      quote: "After years of trying different approaches, I finally found a nutrition plan that works with my body instead of against it. My endurance has doubled and I'm setting new personal records every month. The difference is remarkable!",
      name: "James Wilson",
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-7/12 lg:w-7/12 md:pl-12">
            <div className="mb-8">
              ...
              <h2 className="text-nutricare-primary-dark text-4xl md:text-5xl font-bold">Transforming Lives Through Nutrition</h2>
            </div>
            ...
            <div className="relative bg-nutricare-bg-light rounded-lg p-6 md:p-8 shadow-xl border-t-4 border-nutricare-primary-dark">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h6 className="font-bold text-xl text-nutricare-primary-dark">{testimonials[activeIndex].name}</h6>
