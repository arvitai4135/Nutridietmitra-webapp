            ...
            <div className="lg:pl-8">
              ...
              <div className="mb-6">
                ...
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-nutricare-text-dark leading-tight">
                  We Are Best Nutrition & Health in India.
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                ...
                <div className="flex items-center group">
                  ...
                  <div>
                    <h3 className="text-4xl font-bold text-nutricare-primary-dark">500+</h3>
                    <p className="text-nutricare-text-gray">Happy Customers</p>
                  </div>
                </div>
                ...
                <div className="flex items-center group">
                  ...
                  <div>
                    <h3 className="text-4xl font-bold text-nutricare-primary-dark">820+</h3>
                    <p className="text-nutricare-text-gray">Awards & Features</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:border-nutricare-green hover:shadow-xl transition-all duration-300 group">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-nutricare-text-dark ml-4">Our Mission</h3>
            </div>
            <p className="text-nutricare-text-gray">
              With the help of various personalized nutrition plans, we guide our clients to lead a healthier and more fulfilling life through better food choices.
            </p>
            <div className="mt-6">
              <a href="#learn-more" className="inline-flex items-center text-nutricare-primary-dark group-hover:text-nutricare-green transition-colors duration-300">
                Learn more
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:border-nutricare-green hover:shadow-xl transition-all duration-300 group">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-nutricare-text-dark ml-4">Our Vision</h3>
            </div>
            <p className="text-nutricare-text-gray">
              We strive to reduce pain and suffering caused due to malnutrition worldwide through education, advocacy, and personalized nutrition guidance.
            </p>
            <div className="mt-6">
              <a href="#learn-more" className="inline-flex items-center text-nutricare-primary-dark group-hover:text-nutricare-green transition-colors duration-300">
                Learn more
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:border-nutricare-green hover:shadow-xl transition-all duration-300 group">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-nutricare-text-dark ml-4">Our History</h3>
            </div>
            <p className="text-nutricare-text-gray">
              From our founding 25 years ago, we've been dedicated to revolutionizing nutrition science and making personalized health accessible to everyone.
            </p>
            <div className="mt-6">
              <a href="#learn-more" className="inline-flex items-center text-nutricare-primary-dark group-hover:text-nutricare-green transition-colors duration-300">
                Learn more
