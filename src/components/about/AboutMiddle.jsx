              ...
              <div className="p-4 sm:p-6 md:p-8">
                ...
                <div className="mb-4 sm:mb-6">
                  ...
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base">
                    Founded in 2014 by Dt. Tanu Bhargava, a Jaipur-based
                    dietitian with over 17+ years of expertise, Nutridietmitra
                    empowers 5000+ clients globally with holistic, kitchen-based
                    nutrition plans. Awarded Best Dietitian (2020) and featured
                    in Times of India and Zee News, we deliver sustainable
                    health without supplements.
                  </p>
                </div>
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-xs sm:text-sm md:text-base">
                        With an MSc in Nutrition and Diabetes Educator
                        certification, Dt. Tanu Bhargava’s 17+ years of
                        experience across hospitals, fitness centers, and
                        corporate wellness deliver evidence-based solutions for
                        weight management, PCOS, diabetes, and more.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-xs sm:text-sm md:text-base">
                        Our customized plans for child nutrition, sports
                        performance, pregnancy, and chronic conditions are
                        sustainable, kitchen-based, and free of supplements,
                        serving 5000+ clients with a no-starvation approach.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-xs sm:text-sm md:text-base">
                        Serving clients worldwide with 100% satisfaction,
                        Nutridietmitra’s expertise is recognized in Times of
                        India, Zee News, and awards like Healthcare Achievement
                        (2022), transforming lives globally.
                      </p>
                    </div>
                  </div>
                ...
                <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 bg-white/90 backdrop-blur-sm p-3 sm:p-4 rounded-xl shadow-lg">
                  <div className="grid grid-cols-2 gap-3 sm:gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <h3 className="text-lg sm:text-xl font-bold text-nutricare-primary-dark">
                          17+
                        </h3>
                        <p className="text-nutricare-text-gray text-xs">
                          Years Experience
                        </p>
                      </div>
                    </div>
            ...
            >
              ...
              >
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    <h4 className="text-base sm:text-lg font-semibold text-nutricare-text-dark">
                      Our Mission
                    </h4>
                    <p className="text-nutricare-text-gray text-xs sm:text-sm md:text-base">
                      Founded by Dt. Tanu Bhargava in 2014, Nutridietmitra is
                      dedicated to transforming lives through holistic,
                      kitchen-based nutrition plans. Our science-backed,
                      supplement-free approach empowers clients to achieve
                      sustainable health, focusing on mind, body, and lifestyle
                      without crash diets.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-nutricare-text-gray text-xs sm:text-sm md:text-base">
                      Nutridietmitra has been honored with awards like Best
                      Dietitian (2020) and Healthcare Achievement (2022), and
                      featured in Times of India, Zee News, and other media for
                      our innovative approach to nutrition and wellness.
                    </p>
                  </div>
                  <div>
                    <h4 className="text-base sm:text-lg font-semibold text-nutricare-text-dark">
                    ...
                    <p className="text-nutricare-text-gray text-xs sm:text-sm md:text-base">
                      Serving over 5000 clients worldwide with 100%
                      satisfaction, we offer personalized plans for weight
                      management, PCOS, diabetes, child nutrition, sports
                      performance, and more, delivered through expert online
                      consultations.
                    </p>
                  </div>
                </div>
