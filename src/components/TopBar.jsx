  ...
  try {
    ...
    if (error.response) {
      ...
      if (status === 404) {
        ...
        const errorDetails =
          data.detail?.map((err) => err.msg).join(', ') || 'Invalid input data'
        ...
        try {
          ...
          if (
            ...
            if (typeof setUser === 'function') {
              ...
              setError(
                'Authentication error: Unable to update user data. Please log in again.'
              )
            }
          }
          setLoading(false)
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      if (typeof setUser === 'function') {
        ...
        setError(
          'Authentication error: Unable to save changes. Please log in again.'
        )
      }
    } catch (err) {
        ...
        <div className="container mx-auto px-8 sm:px-9 lg:px-11">
          <div className="flex items-center justify-between">
            ...
            <div
              ...
              title="Go to Home"
            >
              <img src="/Logo1.png" alt="Nutridietmitra" className="h-12" />
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-10 right-0 hidden group-hover:block bg-white shadow-md rounded-md p-2 text-xs text-gray-600 whitespace-nowrap z-20">
                    Plot 93, Mauji Colony Rd, Mauji Colony, Moji Nagar, Malviya
                ...
                <div className="relative group">
                  <a
                    ...
                    className="text-nutricare-primary-dark hover:text-nutricare-primary-light transition-colors duration-300"
                  >
                    <i className="far fa-envelope" title="Email Us"></i>
                  </a>
                  <div className="absolute top-10 right-0 hidden group-hover:block bg-white shadow-md rounded-md p-2 text-xs text-gray-600 whitespace-nowrap z-20">
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="food_plan"
                  value={
                    formatPlanName(user?.meal_plan?.plan_name) || 'No food plan'
                  }
                  readOnly
                  className="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 text-sm sm:text-base px-3 py-2"
                />
