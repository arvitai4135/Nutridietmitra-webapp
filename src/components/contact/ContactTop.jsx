    ...
    <div className="relative w-full overflow-hidden">
      ...
      <div className="relative">
        <img 
          ...
          className="w-full h-[30vh] sm:h-[35vh] md:h-[40vh] lg:h-[45vh] object-cover"
        />
      ...
      <div className="relative bg-white">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 60" preserveAspectRatio="none" className="w-full h-4 sm:h-6 md:h-8 lg:h-10 -mt-1">
