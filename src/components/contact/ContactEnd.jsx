...
const ContactPage = () => {
  ...
  return (
    <div className="font-sans text-nutricare-text-dark w-full">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br  py-16 sm:py-20 lg:py-24 w-full">
        <div className="absolute inset-0 opacity-10 bg-pattern"></div>
        <div className="container mx-auto px-3 sm:px-4 relative z-10">
          <div className="max-w-full sm:max-w-2xl lg:max-w-3xl mx-auto text-center">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-nutricare-primary-dark mb-6">
              Connect with Nutridietmitra
            </h1>
            <p className="text-lg sm:text-xl  opacity-90 mb-8">
              Reach out to Dt. Tanu Bhargava and her team for personalized
              nutrition guidance and support.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
              <a
                href="#contact-form"
                className="bg-nutricare-green hover:bg-nutricare-green-dark text-white font-medium py-3 px-8 rounded-full transition duration-300 inline-flex items-center"
              >
                Send Message
                <svg
              ...
              <button
                ...
                className="bg-white bg-opacity-20 ring-1 ring-nutricare-primary-dark hover:bg-opacity-30  font-medium py-3 px-8 rounded-full transition duration-300 inline-flex items-center text-nutricare-primary-dark"
              >
                <svg
        ...
        <div className="container mx-auto px-3 sm:px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="bg-nutricare-bg-light rounded-xl p-4 sm:p-6 lg:p-8 text-center transition-transform duration-300 hover:-translate-y-2 shadow-md hover:shadow-lg">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-nutricare-primary-dark mb-4">
                Visit Us
              </h3>
              <p className="text-nutricare-text-gray text-sm sm:text-base mb-4">
                OM RESIDENCY 93/B2 Mauji Colony, Malviya Nagar, Jaipur,
                Rajasthan
              </p>
              <a
                href="https://maps.google.com/?q=OM+RESIDENCY+93/B2+Mauji+Colony,+Malviya+Nagar,+Jaipur,+Rajasthan"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block text-nutricare-primary-light hover:text-nutricare-primary-dark font-medium transition duration-300"
              >
                Get Directions
              </a>
            </div>
            ...
            <div className="bg-nutricare-bg-light rounded-xl p-4 sm:p-6 lg:p-8 text-center transition-transform duration-300 hover:-translate-y-2 shadow-md hover:shadow-lg">
              ...
              <p className="text-nutricare-text-gray text-sm sm:text-base mb-4">
                Reach out for nutrition guidance or inquiries
                <br />
                anytime
              </p>
              <a
          ...
          <div className="flex flex-col lg:flex-row -mx-4">
            ...
            <div className="w-full lg:w-1/2 px-4 mb-12 lg:mb-0">
              <div className="max-w-full sm:max-w-md lg:max-w-lg">
                <h2 className="text-2xl sm:text-3xl font-bold text-nutricare-primary-dark mb-4">
                  Reach Our Team
                </h2>
                <p className="text-nutricare-text-gray text-sm sm:text-base mb-10">
                  Contact Dt. Tanu Bhargava directly for personalized nutrition
                  plans or inquiries about our services.
                </p>
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0 mr-6">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-nutricare-primary-light bg-opacity-10 rounded-lg flex items-center justify-center">
                        <svg
                          className="w-5 h-5 sm:w-6 sm:h-6 text-nutricare-primary-light"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div>
                      <h4 className="text-lg sm:text-xl font-bold text-nutricare-primary-dark mb-2">
                        Nutrition Consultations
                      </h4>
                      <h5 className="text-base sm:text-lg font-medium mb-3">
                        Dt. Tanu Bhargava
                      </h5>
                      <ul className="space-y-2">
                        <li className="flex items-center text-nutricare-text-gray text-sm sm:text-base">
                          <svg
                            className="w-4 h-4 mr-2 text-nutricare-green"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg"
                          ...
                          <a
                            href="tel:+917568153534"
                            className="text-nutricare-text-gray hover:text-nutricare-primary-light transition duration-300"
                          >
                            +91-7568153534
                          </a>
                        </li>
                        <li className="flex items-center text-nutricare-text-gray text-sm sm:text-base">
                          ...
                          <a
                            href="mailto:Nutridietmitra@gmail.com"
                            className="text-nutricare-primary-light hover:underline"
                          >
                            Nutridietmitra@gmail.com
                          </a>
                        </li>
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0 mr-6">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-nutricare-green bg-opacity-10 rounded-lg flex items-center justify-center">
                        <svg
                          className="w-5 h-5 sm:w-6 sm:h-6 text-nutricare-green"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                          xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="w-full lg:w-1/2 px-4">
              <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 lg:p-10">
                <h2 className="text-2xl sm:text-3xl font-bold text-nutricare-primary-dark mb-6">
                  Send Your Message
                </h2>
                <p className="text-nutricare-text-gray text-sm sm:text-base mb-8">
                  Have questions about our nutrition plans or food delivery?
                ...
                <form onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                    <div>
                      <label
                        htmlFor="name"
                        className="block text-xs sm:text-sm font-medium text-nutricare-text-gray mb-2"
                      >
                        Your Name
                      </label>
                      <input
