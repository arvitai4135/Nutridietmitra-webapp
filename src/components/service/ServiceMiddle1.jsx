...
import {
  faChevronUp, faChevronDown, faFilter, faBalanceScale, faPlusCircle, faHeartbeat,
  faBaby, faTint, faAppleAlt, faShieldAlt, faDumbbell, faBone, faHeart, faMoon,
  faLeaf, faFemale, faUtensils, faGift, faBreadSlice, faSun
          ...
          {activeCategory !== 'all' && (
            <div className="mb-8 flex items-center justify-center">
              ...
              <h3 className="text-xl font-medium text-nutricare-primary-dark mx-4 flex items-center">
                <FontAwesomeIcon icon={faFilter} size="1x" className="mr-2 text-nutricare-green" />
