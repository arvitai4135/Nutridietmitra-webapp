      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row">
              ...
              <div className="relative mt-6 mx-auto max-w-md">
                <div className="bg-nutricare-primary-dark text-white p-8 rounded-lg shadow-lg text-center min-h-[200px] flex flex-col justify-center">
                  ...
                  <p className="text-white mt-2">
                    +91-7568153534 | nutridietmitra@gmail.com
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full lg:w-1/2 lg:pl-8">
            {/* Section Title */}
            <div className="mb-10">
              <h5 className="uppercase text-nutricare-primary-light font-bold tracking-wide mb-2">
                OUR SERVICES{' '}
              </h5>
              ...
              <p className="text-nutricare-text-gray leading-relaxed text-justify">
                ...
                health issue or a condition, or struggling with having a
                ...
                <div className="bg-nutricare-bg-light rounded-lg overflow-hidden shadow-md transition-transform duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col">
                  ...
                  <div className="p-6 h-[220px] flex flex-col">
                    ...
                    <p className="text-nutricare-text-gray text-sm">
                      Customized, kitchen-based diets designed to address weight
                      loss, PCOS/PCOD, diabetes, and more, without supplements
                      or crash diets.
                    </p>
                  </div>
                </div>
              ...
              <div className="w-full md:w-1/2">
                <div className="bg-nutricare-bg-light rounded-lg overflow-hidden shadow-md transition-transform duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col">
                  ...
                  <div className="p-6 h-[220px] flex flex-col">
                    ...
                    <p className="text-nutricare-text-gray text-sm">
                      A lifestyle-focused approach integrating nutrition,
                      exercise, and wellness strategies to achieve sustainable
                      health transformations for all ages.
                    </p>
                  </div>
                </div>
              </div>
