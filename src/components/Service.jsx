      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-gray-600">
            We combine science-backed methodologies with personalized care to create the most effective health
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-12">
          ...
          <div className="hidden md:block lg:w-1/2 relative">
            <div className="relative h-full w-full overflow-hidden rounded-2xl">
              <img src={HealthCoach} alt="Health coaching session" className="w-full h-full object-cover" />
              ...
              <div className="absolute bottom-8 -right-8 bg-white p-5 rounded-lg shadow-xl max-w-xs z-20">
                ...
                <p className="text-gray-700 italic text-sm">
                  "The nutrition program completely transformed my relationship with food. I've never felt better!"
                </p>
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0 mr-6">
                      <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-nutricare-green bg-opacity-10 group-hover:bg-nutricare-green group-hover:bg-opacity-100 transition-all duration-300">
                        <svg
                          className="w-6 h-6 text-nutricare-green group-hover:text-white transition-colors duration-300"
                          fill="currentColor"
                          viewBox="0 0 24 24"
                        >
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Our evidence-based approach uses 5 metabolic optimization techniques tailored to your unique body
                        composition and lifestyle needs.
                      </p>
                ...
                <div className="group">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Beyond meal plans, our certified coaches provide accountability and motivational strategies proven
                        to foster long-term behavior change.
                      </p>
                      <div className="mt-4 h-px w-16 bg-nutricare-green opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
                    </div>
                  </div>
                ...
                <div className="group">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        We track over 15 key health markers to give you real-time feedback on your progress and make
                        data-driven adjustments to your plan.
                      </p>
                      <div className="mt-4 h-px w-16 bg-nutricare-green opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
                    </div>
                  </div>
