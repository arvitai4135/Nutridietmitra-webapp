...
const Contact = () => {
  ...
  return (
    <section className="relative py-20 overflow-hidden" style={{ backgroundColor: colors.bgLight, fontFamily: 'Arial, sans-serif' }}>
      {/* Background design elements */}
      <div className="absolute -top-24 -right-24 w-64 h-64 rounded-full" style={{ backgroundColor: colors.primaryLight, opacity: 0.1 }}></div>
      <div className="absolute bottom-20 -left-20 w-80 h-80 rounded-full" style={{ backgroundColor: colors.green, opacity: 0.1 }}></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            <div className="mb-2">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full text-white transform hover:rotate-12 transition-transform duration-300" style={{ backgroundColor: colors.primaryDark }}>
            ...
            <p className="text-lg mb-2" style={{ color: colors.textGray }}>
              Discover a holistic approach to health that nourishes your body, mind, and spirit. 
              Our personalized coaching programs empower you to create sustainable habits for lasting vitality.
            </p>
            
            {/* Feature points */}
            <div className="space-y-3 mb-8">
              <div className="flex items-center gap-3">
                <div className="w-6 h-6 rounded-full flex items-center justify-center" style={{ backgroundColor: `${colors.green}30` }}>
          ...
          <div className="lg:w-1/2">
            <div className="relative">
              {/* Decorative elements */}
              <div className="absolute -top-3 -right-3 w-full h-full rounded-2xl border-2" 
                style={{ borderColor: colors.primaryLight }}></div>
              ...
              <div className="absolute -bottom-10 -left-10 bg-white p-5 rounded-xl shadow-lg max-w-xs">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="font-medium" style={{ color: colors.textDark }}>Certified Programs</span>
                </div>
                <p className="text-sm" style={{ color: colors.textGray }}>Our coaching is backed by science and delivered with compassion.</p>
              </div>
            </div>
          </div>
        </div>
