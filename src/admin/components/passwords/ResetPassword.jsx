        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-4 bg-white shadow-xl overflow-auto">
          <div className="w-full max-w-md">
            <div className="mb-6 flex justify-between items-center">
              <div>
                <h2 className="text-2xl font-bold text-nutricare-text-dark">Set New Password</h2>
                <p className="mt-1 text-sm text-nutricare-text-gray">Enter a new password for your account</p>
              </div>
